...
import qorrnsmj.smf.graphic.resource.buffer.VertexBufferObject
import qorrnsmj.smf.graphic.scene.SceneEffects
...
class PostProcessor : Resizable {
    ...
    fun applyPostProcess(effects: SceneEffects) {
        applyPostProcess(effects.postEffects)
    }

...
class StoneBlock(
    ...
    companion object {
        ...
        private val colors = arrayOf(
            ...
            floatArrayOf(1.0f, 1.0f, 1.0f, 1.0f)  // top
        )

        private val uv = arrayOf(
            // front
            floatArrayOf(0.0f, 0.0f), floatArrayOf(1.0f, 0.0f), floatArrayOf(0.0f, 1.0f),
            floatArrayOf(0.0f, 1.0f), floatArrayOf(1.0f, 0.0f), floatArrayOf(1.0f, 1.0f),
